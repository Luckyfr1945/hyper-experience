# ⚡ HYPER EXPERIENCE v5.2.28 (Daily Edition)
...
- **100% Full Battery Bypass:** Once battery hits 100%, charging current cuts to `0mA` and powers the device directly via USB. Eliminates trickle charge heat and prevents battery degradation/swelling.
